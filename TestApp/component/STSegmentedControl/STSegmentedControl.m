...
- (id)initWithFrame:(CGRect)frame {
    if((self = [super initWithFrame:CGRectMake(frame.origin.x, frame.origin.y, frame.size.width, STSegmentedControlHeight)])) {
		 ...
		 */
		normalImageLeft = [UIImage imageNamed:@"normal_left.png"];
		normalImageMiddle = [UIImage imageNamed:@"normal_middle.png"];
		normalImageRight= [UIImage imageNamed:@"normal_right.png"] ;
		selectedImageLeft = [UIImage imageNamed:@"selected_left.png"];
		selectedImageMiddle = [UIImage imageNamed:@"selected_middle.png"];
		selectedImageRight = [UIImage imageNamed:@"selected_right.png"];

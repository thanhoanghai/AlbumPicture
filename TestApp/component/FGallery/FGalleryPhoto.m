...
- (void)loadFullsizeFail:(NSError *)error
{
    if([_delegate respondsToSelector:@selector(galleryPhoto:loadFullsizeFail:)])
		[_delegate galleryPhoto:self loadFullsizeFail:error];
